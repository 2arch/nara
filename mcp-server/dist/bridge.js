...
wss.on('connection', (ws, req) => {
    ...
    if (path === '/mcp') {
        ...
        ws.on('message', (data) => {
            ...
            if ((naraClient === null || naraClient === void 0 ? void 0 : naraClient.readyState) === WebSocket.OPEN) {
        ...
        ws.on('message', (data) => {
            ...
            if ((mcpClient === null || mcpClient === void 0 ? void 0 : mcpClient.readyState) === WebSocket.OPEN) {
